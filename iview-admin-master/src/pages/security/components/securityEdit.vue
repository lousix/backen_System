    ...
    <my-modal :title="userModalTips"
      ...
      <Form ref="userInfo" :model="userForm" :rules="userInfoRules" label-position="top" v-if="showForm">
        ...
        <FormItem  label="描述:" prop="DESCRIPTION">
          <Input type="textarea" v-model="userForm.DESCRIPTION" clearable :maxlength="30" />
        </FormItem>
          ...
          if (this.showForm) {
            this.$refs.userInfo.validate((valid) => {
              if (valid) {
                ...
                this.$http.post(this.isEdit ? 'security/updateUser' : 'security/userAdd',{
                  id: this.userForm.ID,
