...
<template>
  <div class="admin">
    ...
    <content-container>
      ...
      <Table height="425" :columns="columns" :data="userList"></Table>
...
<script>
  import UserEdit from './components/studentEdit'
  export default {
    name: 'Admin',
    data () {
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            key: 'PATH',
            render: (h, params) => {
              let path = params.row.PATH.substr(31)
              return h('span',path)
            }
          },
          {
    ...
    methods: {
      ...
      queryUserByPagination () {
        this.$http.get('student/queryUserByPagination',{
          params: {
            page: this.page,
            rows: this.rows,
      ...
      deleteConfirm (userId) {
        this.$Modal.remove()
        this.$http.post('student/deleteUserById', {
          id: userId
        },{
          _this: this,
          loading: 'loading'
